...
export class DataSetValueRequestMessageHandler extends
    WDXRuntime.WDX.Runtime.Service
        .SingletonService<DataSetValueRequestMessageHandler>()
        implements WDXWSS.WebSocketMessageHandler.IWebSocketMessageHandler {
  type: WDXSchema.WDX.Schema.Message.Type =
      WDXSchema.WDX.Schema.Message.Type.DataSetValueRequest;

  public async handleMessage(
      message: WDXSchema.WDX.Schema.Message.Data.SetValueRequest,
      webSocketKey: string,
  ) {
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'DataSetValueRequestMessageHandler.handleMessage',
        {
    ...
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'DataSetValueRequestMessageHandler.handleMessage.done',
        {
          webSocketKey: webSocketKey,
          messageType: message.type,
          messageUuid: message.uuid,
...
export const Singleton = DataSetValueRequestMessageHandler.getSingleton();
