...
export class RuntimeInfoRequestMessageHandler extends
    WDXRuntime.WDX.Runtime.Service
        .SingletonService<RuntimeInfoRequestMessageHandler>()
        implements WDXWSS.WebSocketMessageHandler.IWebSocketMessageHandler {
  type: WDXSchema.WDX.Schema.Message.Type =
      WDXSchema.WDX.Schema.Message.Type.RuntimeInfoRequest;

  public async handleMessage(
      message: WDXSchema.WDX.Schema.Message.Runtime.InfoRequest,
      webSocketKey: string,
  ) {
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'RuntimeInfoRequestMessageHandler.handleMessage',
        {
    ...
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'RuntimeInfoRequestMessageHandler.handleMessage.done',
        {
          webSocketKey: webSocketKey,
          messageType: message.type,
          messageUuid: message.uuid,
...
export const Singleton =
    RuntimeInfoRequestMessageHandler.getSingleton();
