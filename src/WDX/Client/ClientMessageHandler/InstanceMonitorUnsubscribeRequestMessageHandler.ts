...
export class InstanceMonitorUnsubscribeRequestMessageHandler extends
    WDXRuntime.WDX.Runtime.Service
        .SingletonService<InstanceMonitorUnsubscribeRequestMessageHandler>()
        implements WDXWSS.WebSocketMessageHandler.IWebSocketMessageHandler {
  type: WDXSchema.WDX.Schema.Message.Type =
      WDXSchema.WDX.Schema.Message.Type.InstanceMonitorUnsubscribeRequest;

  public async handleMessage(
      message: WDXSchema.WDX.Schema.Message.Instance.MonitorUnsubscribeRequest,
      webSocketKey: string,
  ) {
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'InstanceMonitorUnsubscribeRequestMessageHandler.handleMessage',
        {
    ...
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'InstanceMonitorUnsubscribeRequestMessageHandler.handleMessage.done',
        {
          webSocketKey: webSocketKey,
          messageType: message.type,
          messageUuid: message.uuid,
...
export const Singleton =
    InstanceMonitorUnsubscribeRequestMessageHandler.getSingleton();
