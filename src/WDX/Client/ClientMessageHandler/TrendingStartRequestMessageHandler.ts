...
export class TrendingStartRequestMessageHandler extends
    WDXRuntime.WDX.Runtime.Service
        .SingletonService<TrendingStartRequestMessageHandler>()
        implements WDXWSS.WebSocketMessageHandler.IWebSocketMessageHandler {
  type: WDXSchema.WDX.Schema.Message.Type =
      WDXSchema.WDX.Schema.Message.Type.TrendingStartRequest;

  public async handleMessage(
      message: WDXSchema.WDX.Schema.Message.Trending.StartRequest,
      webSocketKey: string,
  ) {
    /*! START_REMOVE */ 
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'TrendingStartRequestMessageHandler.handleMessage',
        {
    ...
    WDXRuntime.WDX.Runtime.Service.LogService.debug(
        'TrendingStartRequestMessageHandler.handleMessage.done',
        {
          webSocketKey: webSocketKey,
          messageType: message.type,
          messageUuid: message.uuid,
...
export const Singleton =
    TrendingStartRequestMessageHandler.getSingleton();
