/**
 * Elrest - WDX - WS - Client - JS - Example - Chart - Save Request
 * 
...
(async () => {
    try {
        ...
        console.log(`WDX Chart - Save Request: ${WDXExampleChart.uuid}`);
        ...
        c.trendService.save(WDXExampleChart).subscribe(
            {
                next: (trend) => {
