/**
 * Elrest - WDX - WS - Client - JS - Example - Chart Configuration Request
 * 
 *
...
(async () => {
    try {
        ...
        console.log(`WDX Chart - Configuration Request: ${WDXExampleChart.uuid}`);
        ...
        c.chartService.configuration(WDXExampleChart.uuid).subscribe(
            {
                next: (trend) => {
