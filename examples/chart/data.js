/**
 * Elrest - WDX - WS - Client - JS - Example - Chart Data Request
 * 
...
(async () => {
    try {
        ...
        console.log(`WDX Chart - Data Request: ${WDXExampleChart.uuid}`);
        ...
        c.chartService.data(WDXExampleChart.uuid).subscribe(
            {
                next: (trend) => {
